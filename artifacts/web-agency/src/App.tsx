...
const services = [
  ...
  },
  {
    ...
    features: ["Una página de alto impacto", "Diseño personalizado", "Optimización para móvil", "Formulario de contacto", "Integración con WhatsApp", "Entrega en 1 semana"],
    price: "$7.900 UYU",
    monthly: "~$500 UYU / mes",
    monthlyNote: "Incluye hosting, dominio y pequeños cambios. El costo exacto se confirma al contactarnos.",
  },
  {
    ...
    features: ["Videos publicitarios profesionales", "Reels para redes sociales", "Imágenes creativas para anuncios", "Adaptado a tu identidad de marca", "Edición y postproducción", "Entrega en 5 días"],
    price: "Consultar",
    monthly: null,
